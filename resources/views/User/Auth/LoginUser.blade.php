                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-10 mx-auto">
                            <form class="custom-form ticket-form mb-5 mb-lg-0" action="{{ route('loginuserpost') }}"
                                method="post" id="authForm_login">
                                @csrf
                                ...
                                <h5 class="text-left mb-4" id="form-title">Log In</h5>
                                ...
                                <div class="form-structor">
                                    ...
                                    <div class="login" id="login-form">
                                        ...
                                        <p class="text-center mt-3">
                                            Sudah punya akun? <a href="{{ route('showregister') }}"
                                                id="show-signup">Sign
                                                up</a>
                                        </p>
                                    </div>
